...
func TestMain(m *testing.M) {
	...
	os.Exit(code) //according to code var here ,os will trigger the program to exit or not.o-success,non-zero-failure.
}
...
func addUsers(count int) { //for making dummy table values.
	if count < 1 {
		count = 1
	}
